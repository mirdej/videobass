 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xdc, 0x05 /* = 0x05df = 1500 for HID */
 ...
 */
#define USB_CFG_VENDOR_NAME     'w', 'w', 'w', '.', 'a', 'n', 'y', 'm', 'a', '.', 'c', 'h','/','v','a','m','p'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'v', 'a', 'm', 'p'
...
/* NOTE: we do not use the following define,
   but  the new USB_CFG_DESCR_PROPS_HID_REPORT below. */
